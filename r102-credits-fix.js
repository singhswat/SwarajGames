(()=>{
"use strict";
if(window.__IRONTRAP_R102_CREDITS)return;window.__IRONTRAP_R102_CREDITS=true;
...
function build(){
 ...
 if(!button.dataset.r102Credits){button.addEventListener("click",e=>{e.stopImmediatePropagation();if(typeof show==="function")show("credits");build();start();},true);button.dataset.r102Credits="1";}
 return true;
}
